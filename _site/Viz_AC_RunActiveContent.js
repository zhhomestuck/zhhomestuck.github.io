...
function vizFlashContentWrapper() {
    ...
    if (isShowFlash) {
        ...
        if (isVizVersion) {
            let pagebody = document.getElementsByClassName("pagebody")[0];
